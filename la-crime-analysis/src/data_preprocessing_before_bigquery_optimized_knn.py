...
from sklearn.impute import KNNImputer  # KNNImputer from scikit-learn is used to fill missing values in numerical data using K-Nearest Neighbors (KNN) algorithm.
...
try:
    ...
    for i in range(0, len(numerical_data), chunk_size):
        chunk = numerical_data[i:i + chunk_size]  # Get a chunk of the data
